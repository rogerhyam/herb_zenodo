...
--
-- Host: localhost    Database: herb_zenodo
-- ------------------------------------------------------
...
--
-- Table structure for table `oai_changes`
--

DROP TABLE IF EXISTS `oai_changes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oai_changes` (
...
CREATE TABLE `subject_mapping` (
  ...
  `solr_field` varchar(45) CHARACTER SET utf8 NOT NULL,
...
-- Dump completed on 2020-04-06 20:14:16
